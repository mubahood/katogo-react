...
// Debug: Check localStorage immediately when module loads
console.log('🔍 ChatPage MODULE LOAD - Checking localStorage...');
console.log('🔍 ugflix_auth_token constant value:', ugflix_auth_token);
console.log('🔍 ugflix_user constant value:', ugflix_user);
console.log('🔍 localStorage.getItem(ugflix_auth_token):', localStorage.getItem(ugflix_auth_token));
console.log('🔍 localStorage.getItem(ugflix_user):', localStorage.getItem(ugflix_user));
...
const ChatPage: React.FC<ChatPageProps> = ({ productId, sellerId }) => {
  ...
  useEffect(() => {
    // Get current user
    console.log('🔍 ChatPage useEffect - Getting current user...');
    const user = getCurrentUser();
    console.log('🔍 ChatPage useEffect - User result:', user);
    setCurrentUser(user);
    
    if (user) {
      console.log('✅ User found, loading chat heads...');
      loadChatHeads();
